...
namespace Web.Controllers.ApiControllers
{
    ...
    [ApiController]
    public class Old_MaintenanceSpecificationsApiEndpoint : ControllerBase
    {

        private readonly IUnitOfWork _unitOfWork;

        public Old_MaintenanceSpecificationsApiEndpoint(IUnitOfWork unitOfWork)
        {
        ...
        public IActionResult Get(int id)
        {
            ...
            {
                var result = _unitOfWork.MaintenanceSpecifications.Find(id);
                return Ok(result);
            }
            return NotFound(id);
        }
        ...
        public IActionResult Delete(int id)
        {
            if (MaintenanceSpecificationExists(id))
            {
                _unitOfWork.MaintenanceSpecifications.Remove(_unitOfWork.MaintenanceSpecifications.Find(id));
                _unitOfWork.Complete();
                return NoContent();
            }
            return NotFound(id);
